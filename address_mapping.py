...
def label_mapping(baseaddr, line, instrcnt, exp_instrcnt, labelcnt, label_list, label_addr_list):
    words = line.split()
    ...
    try:
        if words[0][0] == '#':
            ...
            return 0
        elif words[0] == '.RESET_ADDRESS' or words[0] == '.start_address':
...
def address_mapping(labelcnt, label_list, label_addr_list):
